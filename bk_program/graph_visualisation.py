...
class Visualisation:
	...
	def create_vis(self, tree: Tree, graphics: bool, output_dir: str = 'doctest-output') -> None:
		"""
		The method creates a visualisation of a BK-tree/source text for visualisation.
		It is saved to output_dir.
		"""
	...
	def _tree_vis(self, root: Node, dot: graphviz.Digraph) -> None:
		"""
		The method recursively processes children of main root
		to create a visualisation of a BK-tree.
		"""
